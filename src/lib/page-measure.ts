 ...
 *
 * Measures the actual overhead (borders, padding, scrollbar) between the
 * scroll container's outer edge and the page's content area dynamically,
 * so no hardcoded padding constant is needed.
 *
